...
class Profesores extends \AppBundle\Entity\Profesores implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'apellidos', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'edad', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'fechaNacimiento', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'profesion', '' . "\0" . 'AppBundle\\Entity\\Profesores' . "\0" . 'curso'];
        }
